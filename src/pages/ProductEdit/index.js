...
const ProductEdit = ({match, history}) => {
    ...
    const uploadImageHandler = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post('https://e-comerce-mern.herokuapp.com/api/upload', formData, config);
    ...
    return (
        <div className='productedit-page'>
            <Meta title="Product Edit | Book Store" />
            <Container maxWidth={'lg'}>
                <StyledLink to='/admin/productlist/page/1'>Go Back</StyledLink>
